...
//IO方向设置
#define SDA1_IN()  {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=0<<11*2;}	//PB11输入模式
#define SDA1_OUT() {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=1<<11*2;} //PB11输出模式
//IO操作函数	 
#define IIC1_SCL    PBout(10) //SCL
#define IIC1_SDA    PBout(11) //SDA	 
#define READ1_SDA   PBin(11)  //输入SDA 
